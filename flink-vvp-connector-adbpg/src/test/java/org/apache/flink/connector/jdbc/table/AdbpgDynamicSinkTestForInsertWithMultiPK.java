...
public class AdbpgDynamicSinkTestForInsertWithMultiPK extends LegacyJdbcSinkFunctionITCaseBase {
    ...
    public AdbpgDynamicSinkTestForInsertWithMultiPK(boolean mockNullFieldValues) {
        super(
