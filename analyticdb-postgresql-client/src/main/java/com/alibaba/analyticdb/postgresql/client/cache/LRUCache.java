...
import com.alibaba.analyticdb.postgresql.client.function.FunctionWithSQLException;
import com.alibaba.analyticdb.postgresql.client.util.Tuple;
...
public class LRUCache<K, V> {
	...
	public LRUCache(FunctionWithSQLException<K, V> builder) {
		this(-1L, builder);
	}

	public LRUCache(long ttl, FunctionWithSQLException<K, V> builder) {
		this.ttl = ttl;
